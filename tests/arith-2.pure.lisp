...
(with-test (:name :complex-division-minus-zero)
  ...
  (loop for x in (opaque-identity '(2 2.0 #c(2.0 0.0)))
        do (assert (eql (/ x #c(0.0 1.0))
                        (opaque-identity #C(0.0 -2.0)))))
  (checked-compile-and-assert
      ()
      `(lambda (f c)
         ...
         (/ f c))
    ((-2.0 #c(0.0 1.0)) #C(0.0 2.0))
    ((0.0 #c(1 -3.0)) (/ 0 #c(1 -3.0))))
  (checked-compile-and-assert
      ()
      `(lambda (f c)
         (declare (real f)
    ...
    ((-2.0 #c(0.0 1.0)) #C(0.0 2.0))
    ((0.0 #c(1 -3.0)) (/ 0 #c(1 -3.0)))
    ((0  #C(3.0 -4)) (/ 0.0 #C(3.0 -4))))
  (checked-compile-and-assert
      ()
      `(lambda (c)
         (- (/ -3.0 c)))
    ((#c(0 3.0)) (- (opaque-identity (/ (opaque-identity -3.0)
                                        (opaque-identity #c(0 3.0)))))))
  (checked-compile-and-assert
      ()
      `(lambda (a b)
         (declare ((complex float) a b))
