...
is a good idea, but see SB-SYS re. blurring of boundaries.")
  ...
  (:export "%%DATA-VECTOR-REFFERS%%"
           ...
           "%ASINF" "%ASINHF" "%ATANF" "%ATAN2F" "%ATANHF"
           ...
           "ARRAY-DIMENSIONS-EQUAL" "ARRAY-DIMENSIONS-EQUAL-LIST"
           ...
           "VALUES-TYPE-INTERSECTION" "VALUES-TYPE-NTH"
...
(defpackage "SB-C"
  ...
  (:use "CL" "SB-ALIEN-INTERNALS" "SB-ALIEN" "SB-ASSEM" "SB-BIGNUM"
        ...
        "SB-KERNEL" "SB-SYS")
  (:import-from "SB-FASL" "+FIXUP-KINDS+")
  (:import-from "SB-ASSEM" "BRANCH" "FLUSHABLE")
  ;; These are for SB-DEBUG.
  (:intern "SB-C"
  ...
  (:intern "SB-C"
           ...
           "SET-BIT-VECTOR"
           "TEMPLATE-NAME"
           "TN-COST" "TN-GLOBAL-CONFLICTS" "TN-LEAF"
  ...
  (:export "%ALIEN-FUNCALL"
           ...
           "COVERED-FILE-EXECUTED" "COVERED-FILE-LINES" "COVERED-FILE-LOCATIONS"
           "COVERED-FILE-PATHS"
...
structure representations")
  ...
  (:export "*PRIMITIVE-OBJECTS*"
           ...
           #+(or arm64 ppc ppc64 sparc riscv loongarch64) "PSEUDO-ATOMIC-INTERRUPTED-FLAG"
           #+(or arm64 ppc ppc64 sparc riscv loongarch64) "PSEUDO-ATOMIC-FLAG"
           ...
           "STATIC-CODE-SPACE-START" "STATIC-CODE-SPACE-SIZE" "STATIC-CODE-SPACE-END"
