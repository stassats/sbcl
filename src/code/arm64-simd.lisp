...
(declaim (maybe-inline simd-utf8-strlen))
...
(defun test (string &optional (offset 0))
  (declare (inline simd-utf8-strlen)
           (optimize speed))
  (with-pinned-objects (string)
    (simd-utf8-strlen (sap+ (sb-sys:vector-sap string) offset))))
