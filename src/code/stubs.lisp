...
(macrolet ((def (name &optional (args '(x)))
  ...
  (def* (%make-simd-pack-256 (tag p0 p1 p2 p3))
        ...
        (%simd-pack-256-tag))
  #+sb-simd-pack-512
  (def* (%make-simd-pack512 (tag p0 p1 p2 p3 p4 p5 p6 p7))
        (%make-simd-pack512-single (a b c d  e f g h  i j k l  m n o p))
        (%make-simd-pack512-double (a b c d e f g h))
        (%make-simd-pack512-ub64 (a b c d e f g h))
        (%simd-pack-512-tag))
