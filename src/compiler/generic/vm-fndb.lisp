...
(defknown %half-digit-0-or-plusp (half-bignum-element-type) boolean
    (foldable flushable movable always-translatable))
...
(defknown (%half-add-with-carry %half-subtract-with-borrow)
    (half-bignum-element-type half-bignum-element-type (mod 2))
    (values half-bignum-element-type (mod 2))
    (foldable flushable movable always-translatable))
...
(defknown %half-multiply-and-add
    (half-bignum-element-type half-bignum-element-type half-bignum-element-type)
...
(defknown %half-multiply (half-bignum-element-type half-bignum-element-type)
    (values half-bignum-element-type half-bignum-element-type)
    (foldable flushable movable always-translatable))
